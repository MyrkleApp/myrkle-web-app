...
export interface ImportPrivateKeyProps {
  handleBackArrowClick: () => void;
  handleLoginClick: () => void;
}

function ImportPrivateKey({ handleBackArrowClick, handleLoginClick }: ImportPrivateKeyProps) {
  return (
    <Box pos="absolute" top="50%" transform="translateY(-50%)">
      ...
      <TextButtonHStack text="verify my private key" btnFontSize="xs" />
