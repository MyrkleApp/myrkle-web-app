...
import { Box, Flex, HStack, Image, Spacer, Switch, Text, useOutsideClick } from "@chakra-ui/react";
...
function TxnModal({ handleClose }: TxnModalProps) {
  ...
  return (
    ...
    >
      <Box w="50%">
        <Button className="font-face-proxima-nova-black" w="100%" h="35px" fontWeight="bold" mb={7}>
          Transaction Detail
        </Button>
        ...
        <Button className="font-face-proxima-nova-black" w="100%">
          View Flags
        </Button>
      </Box>
      ...
      <Box w="50%" pos="relative">
        ...
        >
          ...
          >
            ...
            intended to force the transaction to take arbitrage opportunities. Most clients do not
            need this.
          </Text>
          ...
          <Text
            ...
            lineHeight={1.4}
          >
            If the specified Amount cannot be sent without spending more than SendMax, reduce the
            received amount instead of failing outright. See Partial Payments for more details.
          </Text>
          ...
          <Text color="textDark" fontSize="xs" pb={2} lineHeight={1.4}>
            Only take paths where all the conversions have an input:output ratio that is equal or
            better than the ratio of Amount:SendMax. See Limit Quality for details.
          </Text>
        </MotionBox>

        <Button className="font-face-proxima-nova-black" w="100%" pos="absolute" bottom="28px">
          View Flags
        </Button>
      </Box>
    </Flex>
